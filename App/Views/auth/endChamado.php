<!-- Modal -->
<div class="modal fade" id="endChamado<?= $chamado['id_chamado'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="modal-footer" action="<?= BASE_URL ?>index.php?route=/Chamados" method="POST">
                <input type="hidden" name="action" value="endChamado">
